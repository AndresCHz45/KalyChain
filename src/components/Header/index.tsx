...
import { useETHBalances, useAggregateKswapBalance } from '../../state/wallet/hooks'
...
import { BRIDGE_PAGE, NETWORK_LABELS, NETWORK_CURRENCY, IDO_PAGE, KLC_PAGE } from 'src/constants'
